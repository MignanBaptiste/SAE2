...
def test_sauver_charger_matchs():
    liste_matchs1 = []
    histoire2foot.sauver_matchs(liste_matchs1, "histoire_test.csv")
    liste_test = histoire2foot.charger_matchs("histoire_test.csv")
    assert liste_matchs1 == liste_test

    liste_matchs2 = histoire2foot.charger_matchs("histoire1.csv")
    histoire2foot.sauver_matchs(liste_matchs2, "histoire_test.csv")
    liste_test = histoire2foot.charger_matchs("histoire_test.csv")
    assert liste_matchs2 == liste_test

    liste_matchs3 = histoire2foot.charger_matchs("histoire1.csv")
    histoire2foot.sauver_matchs(liste_matchs3, "histoire_test.csv")
    liste_test = histoire2foot.charger_matchs("histoire_test.csv")
    assert liste_matchs3 == liste_test

    liste_matchs4 = histoire2foot.charger_matchs("histoire1.csv")
    histoire2foot.sauver_matchs(liste_matchs4, "histoire_test.csv")
    liste_test = histoire2foot.charger_matchs("histoire_test.csv")
